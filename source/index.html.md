...
You can click <a href='https://nhexsg.zendesk.com/hc/en-us/sections/4407023586585-API-Announcements'>Here</a> to view the announcements. If you want to subscribe, please click "Follow" button in the top right of the page. After login and click "Follow" again, then choose the type you want to follow. After you subscribe, the button will be changed to "Following". If you don't have any account, you need to register first in the login dialog.
...
You can manage your API Keys <a href='https://www.nhex.sg/en-us/user/api/'>here</a>.
